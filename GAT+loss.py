...
parser.add_argument('--trbs', type=int, default=77)
...
optimizer = torch.optim.Adam(model.parameters(), lr=learing_rate, weight_decay=1e-3)
...
with open("GAT+loss.txt","a") as file:
